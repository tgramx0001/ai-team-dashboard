...
class TestCrossPlatformSupport(unittest.TestCase):
    ...
    def test_process_tree_kill_posix(self):
        """_kill_process_tree uses os.killpg on POSIX platforms."""
        mock_proc = MagicMock()
        mock_proc.pid = 99999
    ...
    def test_process_tree_kill_windows(self):
        """_kill_process_tree uses taskkill /F /T /PID on Windows platforms."""
        mock_proc = MagicMock()
        mock_proc.pid = 88888
        mock_proc.returncode = None
